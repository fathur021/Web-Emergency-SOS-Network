...
const Register = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-stone-100 font-sans text-stone-900 flex overflow-hidden">
      ...
      <div className={`hidden md:flex md:w-1/2 bg-surface border-r border-stone-200 p-12 flex-col justify-between relative overflow-hidden transition-all duration-700 ease-in-out z-10 ${
        ...
        <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-orange-500/10 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="space-y-6 relative z-10 my-auto">
          ...
          <div className="pt-4 grid grid-cols-2 gap-4 border-t border-stone-200/80">
            <div>
              ...
              <p className="text-xs text-stone-500">Real-time GPS Tracking</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-stone-900">Siaga</p>
              <p className="text-xs text-stone-500">Jaringan Relawan Terdekat</p>
            </div>
          </div>
        </div>
      ...
      <div className={`w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-stone-100 transition-all duration-700 ease-in-out z-10 ${
        isSuccess ? 'translate-x-full opacity-0' : 'translate-x-0 opacity-100'
      }`}>
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-stone-900">Buat Akun Baru</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="p-3.5 bg-surface/70 border border-stone-200 rounded-xl flex items-start gap-3">
              <input
                type="checkbox"
                id="isVolunteer"
                name="isVolunteer"
                ...
                onChange={handleChange}
                className="mt-0.5 w-4 h-4 rounded bg-stone-200 border-stone-300 text-red-400 focus:ring-red-500/20 focus:ring-offset-0 cursor-pointer"
              />
              <label htmlFor="isVolunteer" className="text-xs text-stone-600 cursor-pointer select-none space-y-0.5">
                <span className="font-bold text-stone-900 block flex items-center gap-1.5">
                  <ShieldCheck className="w-3.5 h-3.5 text-blue-600" /> Daftar sebagai Relawan Tanggap Darurat
                </span>
          ...
          <div className="text-center text-xs text-stone-500 pt-2">
            Sudah memiliki akun?{' '}
            <a href="/login" className="text-red-400 hover:text-red-400 font-semibold underline underline-offset-4">
              Masuk di sini
            </a>
          </div>
        </div>
